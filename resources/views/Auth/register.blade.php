    ...
    <div class="tabcontent">
        <form method="POST" action="/register">
            ...
            <div class="form-items">
                ...
                <input type="text" name="name" id="name" placeholder="Tu nombre" value="{{old('name')}}" required/>
            </div>
            <div class="form-items">
                <label for="email">Correo</label>
                <input type="email" name="email" id="email" placeholder="correo@email.com" value="{{old('email')}}" required>
            </div>
            <div class="form-items">
